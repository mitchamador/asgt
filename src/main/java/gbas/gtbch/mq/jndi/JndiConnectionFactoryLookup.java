...
/**
 * JNDI-based {@link javax.jms.ConnectionFactory} implementation.
 *
 * <p>For specific JNDI configuration, it is recommended to configure
 * the "jndiEnvironment"/"jndiTemplate" properties.
 *
 */
public class JndiConnectionFactoryLookup extends JndiLocatorSupport implements ConnectionFactoryLookup {

	public JndiConnectionFactoryLookup() {
		setResourceRef(true);
	}
